...
void ui_mainScreen_screen_init(void)
{
    ...
    // lv_obj_set_style_text_opa(ui_agentButtonLabel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    // lv_obj_set_style_text_font(ui_agentButtonLabel, &lv_font_montserrat_12, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_event_cb(ui_filterSW, ui_event_scanFilterSwitch, LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_agentButton, ui_event_agentButton, LV_EVENT_ALL, NULL);
